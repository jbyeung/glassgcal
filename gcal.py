...
DEFAULT_REFRESH_TIME = 10#3600.0     #auto-refresh every hour

jinja_environment = jinja2.Environment(
    loader=jinja2.FileSystemLoader(os.path.dirname(__file__)))

def auto_refresh(mirror_service, calendar_service, item_id, calendar_title, calendar_id, first_time=None):
	...
	threading.Timer(DEFAULT_REFRESH_TIME, auto_refresh, [mirror_service, calendar_service, item_id, calendar_title, calendar_id]).start()
